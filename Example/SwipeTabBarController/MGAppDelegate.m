...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSArray *viewControllers = @[[[ViewController1 alloc] initWithNib],[[ViewController2 alloc] initWithNib], [[ViewController3 alloc] initWithNib], [[ViewController4 alloc] initWithNib]];
